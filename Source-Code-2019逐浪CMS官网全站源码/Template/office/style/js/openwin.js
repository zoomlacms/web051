...
sdiv(true);
$$('Ajax_sInfo').innerHTML='  <span class="aj_clost" onclick="sdiv(false)"></span> <table cellpadding="0" cellspacing="0" align=center style=" background:url(/Forum/Images/loading.gif) no-repeat"><tr><td  align=center><iframe src="'+url+'" scrolling="no" width="980" height="360" frameborder="0" allowtransparency="true"></iframe></td></tr></table>';
