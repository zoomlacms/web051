...
function AD_Content(o) {
  ...
  return str;
}var ZoneAD_11=new MoveZoneAD("ZoneAD_11");var objAD = new ObjectAD();
objAD.ADID= 20;objAD.ADType= 4;objAD.ADName= "1";objAD.ImgUrl= "/";objAD.ImgWidth       = 0;objAD.ImgHeight      = 0;objAD.FlashWmode     = 0;objAD.ADIntro ="<div id='main_call_w'><div id='main_call'><div id='down'><a href='/pub/' title='免费下载快速通道' target='_balnk'>下载逐浪程序</a></div><div id='server'><a href='{ZL:GetInfoUrl(83)/}' title='我们准备好了为您服务！' target='_balnk'>在线客服</a></div><div id='help'><a href='{ZL:GetInfoUrl(151)/}' title='订购逐浪CMS商业版本' target='_balnk'>商业订购</a></div><div id='buy'><a href='/updata/' target='_balnk' title='最新的更新记录与软件研发动态'>更新记录</a></div><div id='go_top'><a href='#top' title='返回顶部'>TOP</a></div></div></div>";objAD.LinkUrl        = "";objAD.LinkTarget     = 0;objAD.LinkAlt        = "";objAD.Priority       = 1;objAD.CountView      = false;objAD.CountClick     = false;objAD.OverdueDate    = "2039/09/29";objAD.InstallDir     = "/";objAD.ADDIR= "/AD";ZoneAD_11.AddAD(objAD);ZoneAD_11.ZoneID=11;ZoneAD_11.ZoneWidth=30;ZoneAD_11.ZoneHeight=360;ZoneAD_11.ShowType=1;ZoneAD_11.Left=15;ZoneAD_11.Top=200;ZoneAD_11.Delta="0.15";ZoneAD_11.ShowCloseAD="false";ZoneAD_11.CloseFontColor="";ZoneAD_11.LocalityType = "3";ZoneAD_11.Show();