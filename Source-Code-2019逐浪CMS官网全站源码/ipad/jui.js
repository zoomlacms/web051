    ...
    return this.each(function () {
      ...
      if (_55) {
        ...
        $.data(this, "linkbutton", {
          options: $.extend({}, $.fn.linkbutton.defaults, $.fn.linkbutton.parseOptions(this), _53)
        });
...
(function ($) {
  ...
  function _8e(_8f) {
    ...
    _91.find("div.tree-node").draggable({
      disabled: false,
      revert: true,
      cursor: "pointer",
      proxy: function (_92) {
    ...
    return this.each(function () {
      ...
      if (_15b) {
        ...
        _15b = $.data(this, "progressbar", {
          options: $.extend({}, $.fn.progressbar.defaults, $.fn.progressbar.parseOptions(this), _158),
          bar: init(this)
        });
      }
...
(function ($) {
  ...
  function _1bb(_1bc) {
    ...
    var win = $(_1bc).panel($.extend({}, _1bd.options, {
      border: false,
      doSize: true,
      closed: true,
      cls: "window",
      headerCls: "window-header",
      bodyCls: "window-body " + (_1bd.options.noheader ? "window-body-noheader" : ""),
      onBeforeDestroy: function () {
    ...
    _1c6.window.draggable({
      ...
      onStartDrag: function (e) {
        ...
        _1c6.proxy.css({
          ...
          left: e.data.left,
          top: e.data.top,
          width: ($.boxModel == true ? (_1c6.window.outerWidth() - (_1c6.proxy.outerWidth() - _1c6.proxy.width())) : _1c6.window.outerWidth()),
          height: ($.boxModel == true ? (_1c6.window.outerHeight() - (_1c6.proxy.outerHeight() - _1c6.proxy.height())) : _1c6.window.outerHeight())
        });
        setTimeout(function () {
          if (_1c6.proxy) {
            _1c6.proxy.show();
    ...
    return this.each(function () {
      ...
      if (_1ca) {
        ...
        _1ca = $.data(this, "window", {
          options: $.extend({}, $.fn.window.defaults, $.fn.window.parseOptions(this), _1c7)
        });
  ...
  $.fn.window.parseOptions = function (_1cf) {
    var t = $(_1cf);
    return $.extend({}, $.fn.panel.parseOptions(_1cf), {
  ...
  function _1d3(_1d4) {
    ...
    $(_1d4).window($.extend({}, opts, {
      ...
      onResize: function (_1db, _1dc) {
        ...
        _1d5.panel("resize", {
          width: _1dd.width(),
          height: (_1dc == "auto") ? "auto" : _1dd.height() - _1dd.find(">div.dialog-toolbar").outerHeight() - _1dd.find(">div.dialog-button").outerHeight()
        });
        if (opts.onResize) {
  ...
  $.fn.dialog = function (_1e1, _1e2) {
    ...
    return this.each(function () {
      ...
      if (_1e4) {
        ...
        $.data(this, "dialog", {
          options: $.extend({}, $.fn.dialog.defaults, $.fn.dialog.parseOptions(this), _1e1),
  ...
  $.fn.tabs = function (_285, _286) {
    ...
    return this.each(function () {
      ...
      if (_287) {
        ...
        $.data(this, "tabs", {
          options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _285),
          tabs: _256(this),
          selectHis: []
        });
      }
  ...
  function _2aa(_2ab, _2ac) {
    ...
    if (_2ac == "east") {
      ...
      _2ad.center.panel("resize", {
        width: _2ad.center.panel("options").width + _2ad.east.panel("options").width - 28
      });
      ...
      if (_2ac == "west") {
        ...
        _2ad.center.panel("resize", {
          width: _2ad.center.panel("options").width + _2ad.west.panel("options").width - 28,
          left: 28
        });
        ...
        if (_2ac == "north") {
          ...
          if (_2ac == "south") {
            ...
            _2ad.south.panel("panel").animate({
              ...
              _2ad.expandSouth.panel("open").panel("resize", {
                top: cc.height() - 28,
                left: 0,
                width: cc.width(),
                height: 28
            ...
            if (!_2ad.expandSouth) {
              ...
              _2ad.expandSouth.panel("panel").click(function () {
                _2ad.south.panel("open").panel("resize", {
                  top: cc.height()
                });
                _2ad.south.panel("panel").animate({
                  top: cc.height() - _2ad.south.panel("options").height
                });
                return false;
              });
            }
      ...
      if (_2b1 == "west" && _2b2.expandWest) {
        ...
        if (_2b1 == "north" && _2b2.expandNorth) {
          ...
          if (_2b1 == "south" && _2b2.expandSouth) {
            ...
            _2b2.south.panel("panel").animate({
              top: cc.height() - _2b2.south.panel("options").height
            }, function () {
              _297(_2b0);
    ...
    return this.each(function () {
      ...
      if (_2f2) {
        ...
        $.data(this, "menubutton", {
          options: $.extend({}, $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _2f0)
        });
        $(this).removeAttr("disabled");
      }
      init(this);
    ...
    return this.each(function () {
      ...
      if (_2fd) {
        ...
        $.data(this, "splitbutton", {
          options: $.extend({}, $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _2fb)
        });
        $(this).removeAttr("disabled");
      }
      init(this);
    ...
    return this.each(function () {
      ...
      if (_313) {
        ...
        _313 = $.data(this, "searchbox", {
          options: $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _311),
          searchbox: init(this)
        });
      }
      _304(this);
    ...
    return this.each(function () {
      ...
      if (_32d) {
        ...
        $.data(this, "validatebox", {
          options: $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _32b)
        });
      }
      _31c(this);
    });
    ...
    return this.each(function () {
      ...
      if (_358) {
        ...
        _358 = $.data(this, "numberbox", {
          options: $.extend({}, $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _355)
        });
        $(this).removeAttr("disabled");
        $(this).css({
          imeMode: "disabled"
    ...
    return this.each(function () {
      ...
      if (_37b) {
        ...
        _37b = $.data(this, "calendar", {
          options: $.extend({}, $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _379)
        });
        init(this);
      }
    ...
    return this.each(function () {
      ...
      if (_38e) {
        ...
        _38e = $.data(this, "spinner", {
          options: $.extend({}, $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _38b),
          spinner: init(this)
        });
        $(this).removeAttr("disabled");
      }
    ...
    return this.each(function () {
      ...
      if (_39a) {
        ...
        $.data(this, "numberspinner", {
          options: $.extend({}, $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _397)
        });
      }
      _393(this);
    });
    ...
    return this.each(function () {
      ...
      if (_3b4) {
        ...
        $.data(this, "timespinner", {
          options: $.extend({}, $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _3b1)
        });
        _39d(this);
      }
    });
...
(function ($) {
  ...
  function _40b(_40c) {
    ...
    _411.children("div.datagrid-header").find("div.datagrid-cell").resizable({
      onStopResize: function (e) {
  ...
  $.fn.datagrid.parseOptions = function (_528) {
    var t = $(_528);
    return $.extend({}, $.fn.panel.parseOptions(_528), {
...
(function ($) {
  ...
  $.fn.treegrid = function (_61d, _61e) {
    ...
    return this.each(function () {
      ...
      if (_620) {
        ...
        $.data(this, "treegrid", {
          options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _61d),
          data: []
        });
      }
      _59b(this);
  ...
  var _628 = $.extend({}, $.fn.datagrid.defaults.view, {
...
(function ($) {
    ...
    return this.each(function () {
      ...
      if (_69b) {
        ...
        _69b = $.data(this, "combo", {
          options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _699),
          combo: r.combo,
          panel: r.panel,
          previousValue: null
        });
  ...
  $.fn.combo.parseOptions = function (_6a0) {
    var t = $(_6a0);
    return $.extend({}, $.fn.validatebox.parseOptions(_6a0), {
    ...
    return this.each(function () {
      ...
      if (_6d1) {
        ...
        _6d1 = $.data(this, "combobox", {
          options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _6ce)
        });
        _6cc(this);
        _6c0(this, _6be(this));
      }
  ...
  $.fn.combotree = function (_6e7, _6e8) {
    ...
    return this.each(function () {
      ...
      if (_6ea) {
        ...
        $.data(this, "combotree", {
          options: $.extend({}, $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _6e7)
        });
      }
      _6db(this);
    });
...
(function ($) {
    ...
    return this.each(function () {
      ...
      if (_708) {
        ...
        _708 = $.data(this, "combogrid", {
          options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _705)
        });
      }
      _6ee(this);
    });
  ...
  $.fn.combogrid.parseOptions = function (_70b) {
    var t = $(_70b);
    return $.extend({}, $.fn.combo.parseOptions(_70b), $.fn.datagrid.parseOptions(_70b), {
  ...
  $.fn.datebox = function (_71c, _71d) {
    ...
    return this.each(function () {
      ...
      if (_71f) {
        ...
        $.data(this, "datebox", {
          options: $.extend({}, $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _71c)
        });
      }
      _70c(this);
    });
    ...
    return this.each(function () {
      ...
      if (_738) {
        ...
        $.data(this, "datetimebox", {
          options: $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _735)
        });
      }
      _722(this);
    });
