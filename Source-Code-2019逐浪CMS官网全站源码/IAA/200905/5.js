...
function AD_Content(o) {
  ...
  return str;
}var ZoneAD_5=new MoveZoneAD("ZoneAD_5");var objAD = new ObjectAD();
objAD.ADID= 9;objAD.ADType= 4;objAD.ADName= "宣传片广告";objAD.ImgUrl= "/";objAD.ImgWidth       = 0;objAD.ImgHeight      = 0;objAD.FlashWmode     = 0;objAD.ADIntro ="<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='380' height='320'><param name='movie' value='http://www.zoomla.cn/skin/2009/flv.swf?file=http://www.zoomla.cn/down/zoomla_video.flv&autostart=true' /><param name='menu' value='false' /><param name='play' value='true' /><param name='wmode' value='transparent' /><param name='quality' value='high' /></object>";objAD.LinkUrl        = "";objAD.LinkTarget     = 0;objAD.LinkAlt        = "";objAD.Priority       = 1;objAD.CountView      = false;objAD.CountClick     = false;objAD.OverdueDate    = "2038/06/16";objAD.InstallDir     = "/";objAD.ADDIR= "/IAA";ZoneAD_5.AddAD(objAD);ZoneAD_5.ZoneID=5;ZoneAD_5.ZoneWidth=400;ZoneAD_5.ZoneHeight=360;ZoneAD_5.ShowType=1;ZoneAD_5.Left=5;ZoneAD_5.Top=5;ZoneAD_5.Delta=1;ZoneAD_5.ShowCloseAD=true;ZoneAD_5.CloseFontColor="#0066FF";ZoneAD_5.LocalityType = 4;ZoneAD_5.Show();