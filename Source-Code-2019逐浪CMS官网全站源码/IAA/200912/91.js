...
function AD_Content(o) {
  ...
  return str;
}var ZoneAD_91=new BannerZoneAD("ZoneAD_91");var objAD = new ObjectAD();
objAD.ADID= 19;objAD.ADType= 3;objAD.ADName= "复制复制fffffff";objAD.ImgUrl= "/";objAD.ImgWidth       = 0;objAD.ImgHeight      = 0;objAD.FlashWmode     = 0;objAD.ADIntro ="ffffff";objAD.LinkUrl        = "";objAD.LinkTarget     = 0;objAD.LinkAlt        = "";objAD.Priority       = 1;objAD.CountView      = false;objAD.CountClick     = false;objAD.OverdueDate    = "2010/01/11";objAD.InstallDir     = "/";objAD.ADDIR= "IAA";ZoneAD_91.AddAD(objAD);ZoneAD_91.ZoneID=91;ZoneAD_91.ZoneWidth=468;ZoneAD_91.ZoneHeight=60;ZoneAD_91.ShowType=1;ZoneAD_91.Show();