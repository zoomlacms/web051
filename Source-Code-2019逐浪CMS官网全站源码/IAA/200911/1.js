...
function AD_Content(o) {
  ...
  return str;
}var ZoneAD_1=new FixedZoneAD("ZoneAD_1");var objAD = new ObjectAD();
objAD.ADID= 7;objAD.ADType= 1;objAD.ADName= "gggg";objAD.ImgUrl= "/fgdgd";objAD.ImgWidth       = 0;objAD.ImgHeight      = 0;objAD.FlashWmode     = 0;objAD.ADIntro ="fgfgds";objAD.LinkUrl        = "";objAD.LinkTarget     = 1;objAD.LinkAlt        = "fg";objAD.Priority       = 1;objAD.CountView      = false;objAD.CountClick     = false;objAD.OverdueDate    = "2009/12/14";objAD.InstallDir     = "/";objAD.ADDIR= "IAA";ZoneAD_1.AddAD(objAD);ZoneAD_1.ZoneID=1;ZoneAD_1.ZoneWidth=468;ZoneAD_1.ZoneHeight=60;ZoneAD_1.ShowType=1;ZoneAD_1.Left= 100;ZoneAD_1.Top= 100;ZoneAD_1.ShowCloseAD=false;ZoneAD_1.CloseFontColor="#FFFFFF";ZoneAD_1.LocalityType = 1;ZoneAD_1.Show();