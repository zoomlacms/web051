...
objAD.ADID= 11;objAD.ADType= 1;objAD.ADName= "4.0发布广告";objAD.ImgUrl= "/UploadFiles//IAA/200910/200910310303383845.jpg";objAD.ImgWidth       = 0;objAD.ImgHeight      = 0;objAD.FlashWmode     = 0;objAD.ADIntro ="";objAD.LinkUrl        = "http://www.zoomla.cn/Content.aspx?ItemID=545";objAD.LinkTarget     = 1;objAD.LinkAlt        = "信守承诺、品质如山-逐浪CMS4.0正式发布";objAD.Priority       = 1;objAD.CountView      = false;objAD.CountClick     = false;objAD.OverdueDate    = "2038/11/03";objAD.InstallDir     = "/";objAD.ADDIR= "IAA";ZoneAD_4.AddAD(objAD);var objAD = new ObjectAD();
objAD.ADID= 8;objAD.ADType= 1;objAD.ADName= "内容页970*138banner-2";objAD.ImgUrl= "/skin/2009/2009jcr2.jpg";objAD.ImgWidth       = 0;objAD.ImgHeight      = 0;objAD.FlashWmode     = 0;objAD.ADIntro ="";objAD.LinkUrl        = "/Content.aspx?ItemID=166";objAD.LinkTarget     = 1;objAD.LinkAlt        = "高效的商城解决方案就在选择Zoomla!逐浪CMS!";objAD.Priority       = 1;objAD.CountView      = true;objAD.CountClick     = true;objAD.OverdueDate    = "2038/03/02";objAD.InstallDir     = "/";objAD.ADDIR= "IAA";ZoneAD_4.AddAD(objAD);var objAD = new ObjectAD();
objAD.ADID= 7;objAD.ADType= 1;objAD.ADName= "内容页970*138banner";objAD.ImgUrl= "/skin/2009/2009jcrj.jpg";objAD.ImgWidth       = 0;objAD.ImgHeight      = 0;objAD.FlashWmode     = 0;objAD.ADIntro ="";objAD.LinkUrl        = "/Content.aspx?ItemID=393";objAD.LinkTarget     = 1;objAD.LinkAlt        = "贴心软件中国行—逐浪CMS技术团队京津行与您面对面";objAD.Priority       = 1;objAD.CountView      = true;objAD.CountClick     = true;objAD.OverdueDate    = "2038/03/02";objAD.InstallDir     = "/";objAD.ADDIR= "IAA";ZoneAD_4.AddAD(objAD);ZoneAD_4.ZoneID=4;ZoneAD_4.ZoneWidth=970;ZoneAD_4.ZoneHeight=138;ZoneAD_4.ShowType=3;ZoneAD_4.Show();